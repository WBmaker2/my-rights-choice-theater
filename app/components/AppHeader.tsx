...
export function AppHeader({ progress, stepLabel, stepCurrent, stepTotal, showProgress, showEnd, onUrgentHelp, onEnd }: AppHeaderProps) {
  return (
    <header className={showProgress ? "app-header" : "app-header app-header-simple"}>
